...
public class VectorQuantizer
{
    ...
    {
        var maxComponent = MathF.Abs(TensorPrimitives.MaxMagnitude(rawEmbedding));
        ...
        *(float*)Unsafe.AsPointer(ref embeddingRepresentation[rawEmbedding.Length]) = MathF.Sqrt(sumOfSquaredMagnitudes);
